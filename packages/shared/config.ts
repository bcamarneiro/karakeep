...
const allEnv = z.object({
  ...
  CRAWLER_INSTAGRAM_STORE_IMAGES: stringBool("false"),
  CRAWLER_INSTAGRAM_HEADERS_JSON: instagramHeadersSchema,
  CRAWLER_YOUTUBE_ENABLED: stringBool("false"),
  CRAWLER_YOUTUBE_SUB_LANGS: z.string().default("en.*"),
...
const serverConfigSchema = allEnv.transform((val, ctx) => {
  const obj = {
    ...
    crawler: {
      ...
      instagramStoreImages: val.CRAWLER_INSTAGRAM_STORE_IMAGES,
      instagramHeaders: val.CRAWLER_INSTAGRAM_HEADERS_JSON,
      youtubeEnabled: val.CRAWLER_YOUTUBE_ENABLED,
      youtubeSubLangs: val.CRAWLER_YOUTUBE_SUB_LANGS,
